...
export function RightPanel({ unlocked }: RightPanelProps) {
  const [activeTab, setActiveTab] = useState<"messageBoard" | "leaderboard">("leaderboard");
            ...
            <div className="flex flex-col gap-4">
              {leaderboard.length === 0 ? (
                ...
                leaderboard.map((entry, idx) => (
                  <div key={entry.countryCode} className="flex justify-between items-center bg-white p-4 shadow rounded">
